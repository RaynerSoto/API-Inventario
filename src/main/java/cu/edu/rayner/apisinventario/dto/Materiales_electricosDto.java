...
public class Materiales_electricosDto extends ProductoDto{
    ...
    public Materiales_electricosDto(Long id, Double tamanno, Colores colores, Double precio, boolean fragile, String envase, long lote, String nombre_seccion, double voltage) {
